...
<div id="<?php print $post_id; ?>" class="<?php print $classes; ?>" <?php print $attributes; ?>>
  <div class="forum-post-info clearfix">
    ...
    <?php if ($comment->created == ''){ print format_date($node->created, 'custom', 'd. M. Y - H:i'); }else{print format_date($comment->created, 'custom', 'd. M. Y - H:i');} ?>
      <?php //print format_date($node->created, 'custom', 'd-m-Y H:i')?>
